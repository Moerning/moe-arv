                        ...
                        <MenuItems as="section">
                            <div class="relative">
                                <div class="article-controls">
                                    <MenuItem>
                                        <router-link :to="{ name:'EditArticle', params: { slug: row.slug } }">
                                            <button class="default-menu-btn">Edit</button>
                                        </router-link>
                                    </MenuItem>
                                    <MenuItem>
                                    <button @click="initDelete(row)" class="default-menu-btn">Delete</button>
                                    </MenuItem>
                                </div>
                            </div>
                        </MenuItems>
    ...
    <BasicDialog title="Delete Article" ref="deleteConfirm"> 
        <div class="p-4 flex flex-col gap-8">
            ...
            <div class="grid grid-cols-2 gap-4">
                <BasicButton theme="danger" @click="doDeleteArticle">Yes, delete</BasicButton>
                <BasicButton theme="white" @click="toggleDialog">Cancel</BasicButton>
            </div>
        </div>
    </BasicDialog>
</template>
